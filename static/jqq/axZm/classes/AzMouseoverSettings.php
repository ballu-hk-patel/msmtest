...
if (!class_exists('AzMouseoverSettings', false)) {
    ...
    {
        public $vendor = '';
        public $last_updated = '2020-11-05';
        public $config = array();
        public $items = array();
...
<ul>
    ...
    <li>"hotspotFilePath" - Optionally you can define "hotspotFilePath" for each images
        ...
        For more information see <a href="https://www.ajax-zoom.com/examples/example33.php">example33.php</a>
...
<ul>
    ...
    <li>"hotspotFilePath" - optional path to the file which contains data for hotspots. For more information see
        <a href="https://www.ajax-zoom.com/examples/example33.php">example33.php</a>
        or JSON / JS object with hotspots configuration.
    </li>
    <li>"crop" - JSON generated with <a href="https://www.ajax-zoom.com/examples/example35.php">example35.php</a>
...
and there is only one image, only one 360 or no images / 360s at all,
then the container represented by "galleryDivID" option is hidden
...
Wenn Galerie nicht angezeigt werden soll, dann wird diese CSS Klasse dem Container automatisch hinzugefügt.
...
siehe https://www.ajax-zoom.com/index.php?cid=blog&article=axzm_thumb_slider&lang=en'
                    )
                ),
...
kleiner ist als diese Zahl und die Position passt.'
                ...
                'thumbSliderMinSize' => array(
                    ...
                    'comment' => array(
                        'EN' => '
The minimal size of the player so that the gallery displays.
Otherwise it is hidden.
See also the "dotNavigation" option!',
                        'DE' => '
Die minimale Größe des Players, damit die Galerie angezeigt wird.
Ansonsten ist sie versteckt.
Siehe auch die "dotNavigation" Option!',
                    )
                ),
...
"thumbSliderDimensionHorz" und anderen Optionen ein, wenn Galerie horizontal erscheint.'
                    )
                ),
...
Thumb margin when set instantly for horizontal gallery.',
                        'DE' => '
Abstand der Miniaturansichten in horizontalen Galerie, wenn "thumbSliderAutoSizeHorz" eingeschaltet ist.'
                    )
                ),
...
Thumb margin when set instantly for vertical gallery.',
                        'DE' => '
Abstand der Miniaturansichten in vertikallen Galerie,
wenn "thumbSliderAutoSizeHorz" eingeschaltet ist.'
                    )
                ),
...
If only filename without path is defined the path presumed to be the
/axZm/icons folder. You can also set complete different paths including the image filename instead.',
                        'DE' => '
...
Sie können stattdessen auch komplett andere Pfade inklusive der Bilddatei definieren.'
                ...
                'images360Big' => array(
                    ...
                    'comment' => array(
                        'EN' => '
Placeholder image when 360 is slided.
If only filename without path is defined the path presumed to be the /axZm/icons folder.
You can also set complete different paths including the image filename instead.',
                        'DE' => '
Platzhalterbild, wenn 360 verschoben wird.
Wenn nur Dateiname ohne Pfad definiert ist, werden die Pfade im /axZm/icons Ordner vermutet.
Sie können stattdessen auch komplett andere Pfade inklusive der Bilddatei definieren.'
                    )
                ),
...
Die configuration des Sets kann in /axZm/zoomConfigCustom.inc.php gefunden / erweitert werden.'
                    )
                ),
...
Preload all preview and mouseover images, possible values: false, true oder "oneByOne".',
                        'DE' => '
Alle Bilder für das Mouseover vorladen. Mögliche Werte sind false, true oder "oneByOne".'
                    )
                ),
...
a value of 0.8 to 80% of window height; you can also define two values, e.g. \'1.0|-120\',
...
https://www.ajax-zoom.com/index.php?cid=docs#onBeforeStart',
                        'DE' => '
AJAX-ZOOM kann mit zahlreichen Callbacks bzw. Hooks erweitert werden.
Docu: https://www.ajax-zoom.com/index.php?cid=docs#onBeforeStart'
                    )
                ),
...
https://www.ajax-zoom.com/index.php?cid=blog&article=axzm_thumb_slider&lang=en',
                        'DE' => '$.axZmThumbSlider Optionen für Vollbild Galerie.
...
If you want to disable the slider at fullscreen, you can achieve that via the "fsSliderMinSize" option!',
                        'DE' => '
...
einstellbaren Logik, beschrieben in "fsSliderPositionSwitch" Option, die Position sich dynamisch verändern kann.
Wenn Sie die Galerie im Vollbild deaktivieren möchten, können Sie dies über die "fsSliderMinSize" Option erreichen!'
                    )
                ),
...
Dummy für künftige Implementierung (todo).'
                ...
                'fsSliderMinSize' => array(
                    ...
                    'comment' => array(
                        'EN' => '
The minimal size of the player so that the fullscreen gallery displays.
Otherwise it is hidden.
See also the "dotNavigation" option!',
                        'DE' => '
Die minimale Größe des Players, damit die Vollbild-Galerie angezeigt wird.
Ansonsten wird sie ausgeblendet.
Siehe auch die "dotNavigation" Option!',
                    )
                ),
...
Disable mouseover zoom if it is inside (inner zoom) and touch event.',
                        'DE' => '
Mouseover-Zoom deaktivieren, wenn es "inside" ist und es sich um Touch-Geräte handelt.'
                    )
                ),
...
Enable mouseover zoom and slider at the same time for not touch devices.',
                        'DE' => '
Aktivieren des Mouseover-Zoom und Sliders für Vorschaubilder gleichzeitig für nicht Touch-Geräte.'
                    )
                ),
...
Breite bzw. Höhe kleiner als dieser Wert sind. Setzen Sie diese Option auf false um sie auszuschalten.'
                    )
                ),
...
Speed of inner fade or false.',
                        'DE' => '
Die Geschwindigkeit des Blendvorganges in ms beim Wechsel zwischen den Bildern oder false.'
                    )
                ),
...
Speed of shutter fadein or false; applies only if image proportions are different from container.',
                        'DE' => '
Die Geschwindigkeit der Anpassung von Proportionen während des Überblendvorgangs in ms oder false.'
                    )
                ),
...
Speed for flyout or false to disable.',
                        'DE' => '
Geschwindigkeit des "Ausfliegens" des Zoom Fensters in ms oder false zum Deaktivieren.'
                    )
                ),
...
Speed for fly back or false to disable.',
                        'DE' => '
Geschwindigkeit des "Zurückfliegens" des Zoom Fensters in ms oder false zum Deaktivieren.'
                    )
                ),
...
Opacity of the area around the lens when "tint" option is set to some color value.',
                        'DE' => '
Durchsichtigkeit der Fläche um die Linse herum, wenn "tint" Option einen Wert hat.'
                    )
                ),
...
as parent container for title other than inside the lense, can be anywhere.',
                        'DE' => '
...
https://fgnass.github.com/spin.js/',
                        'DE' => '
Optionen für den Spinner, siehe auch https://fgnass.github.com/spin.js/'
                    )
                ),
...
from youtube, vimeo etc. fails.',
                        'DE' => '
Ersatz für Posterbild, wenn das Laden von YouTube, Vimeo etc. nicht funktioniert.'
                    )
                ),
...
Standard Optionen für Videojs Player.'
        ...
        public function docuCat($l, $key)
        {
            ...
            ? $this->categories[$key]['title'][$l] : $this->categories[$key]['title']['EN']).'</th></tr></tbody>';
        }

        public function getDocu($c = array())
        {
            $mouse_over_zoom_param = array(
                'EN' => 'All specific options for the mouseover zoom are keys of mouseOverZoomParam object!',
                'DE' => 'Alle spezifische optionen für mousever zoom sind Schlüßel des mouseOverZoomParam Objektes!'
            );
                ...
                if ($cat != $cat_prev) {
                    ...
                    if ($cat == 'mouseover') {
                        $ret .= '<tr><td>mouseOverZoomParam</td><td>{... ... ...}<td>'
                            ...
                            ? $mouse_over_zoom_param[$l]
                            : $mouse_over_zoom_param['EN']).'</td>';
                    }
...
.optionsTable {width: 100%; border-spacing: 0; font-size: 10pt; font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;}
...
<p>AJAX-ZOOM is a multipurpose library for displaying (high resolution) images and 360°/3D spins. <br>
    ...
    <a target="_blank" href="https://www.ajax-zoom.com/examples/example32.php">
...
<ol style="margin-left: 25px; list-style: decimal">
    <li><a href="javascript:void(0)"
        onclick="Fieldset.az_open(\'axzoom_options_general_settings\', \'axzoom_options_general_settings_azOptions\')">azOptions</a>
        - for 2D zoom
    </li>
    <li><a href="javascript:void(0)"
        onclick="Fieldset.az_open(\'axzoom_options_general_settings\', \'axzoom_options_general_settings_azOptions360\')">
        azOptions360</a> - for 360/3D zoom
    </li>
</ol><br>
Depending on the template used you might need to adjust especially these two options:
<ol style="margin-left: 25px; list-style: decimal">
    <li><a href="javascript:void(0)"
        onclick="Fieldset.az_open(\'axzoom_options_mouseover\', \'axzoom_options_mouseover_zoomWidth\')">zoomWidth</a>
        - width of the mouseover flyout window
    </li>
    <li><a href="javascript:void(0)"
        onclick="Fieldset.az_open(\'axzoom_options_mouseover\', \'axzoom_options_mouseover_zoomHeight\')">zoomHeight</a>
        - height of the mouseover flyout window
    </li>
</ol><br>
